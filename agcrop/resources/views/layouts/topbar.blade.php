    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="assets/images/fav.png" alt="" height="30" width="30">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <!-- <ul class="metismenu list-unstyled" id="side-menu">
                    <li class="menu-title" data-key="t-menu">@lang('translation.Get_A_Quote')</li>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                waves-light" style="background: #0069a5;">
                                    <a class=" dropdown-toggle arrow-none" href="{{ route('requisition.index') }}"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end"
                    ...
                    <!-- <img class="rounded-circle header-profile-user"
                        ...
                        alt="Header Avatar"> -->
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::user() != null ? Auth::user()->name : ''}}</span>
