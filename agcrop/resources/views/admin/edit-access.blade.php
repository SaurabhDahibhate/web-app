...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Edit Access  @endslot
    @endcomponent
                    ...
                    @method('PATCH')
                      @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" value="{{ $access->access_name }}" 
                            name="access_name" id="default-input" placeholder="Enter Access" required>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary"> Edit Access</button>
