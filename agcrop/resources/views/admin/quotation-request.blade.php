...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Quotation Request @endslot
    @endcomponent
                        ...
                        <div class="col-sm">
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light"><i
                                        class="bx bx-plus me-1"></i> Add Quotation</button>
                            </div> -->
                        </div>
                            ...
                            <div class="d-flex align-items-center gap-1 mb-4">
                                <!-- <div class="mb-4">
                                    <button type="button" class="btn btn-light waves-effect waves-light">
                                        ...
                                        <i class="bx bx-plus me-1"></i> Add Quotation</a>
                                    </button>
                                </div> -->
                            </div>
                        </div>
                        ...
                        <table class="table align-middle datatable dt-responsive table-check nowrap"
                            ...
                            <thead>
                                <tr class="bg-transparent">
                                    ...
                                    <th style="width: 120px;">Quotation ID</th>
                                    <th>Customer Name</th>
                                    <th>Status</th>
