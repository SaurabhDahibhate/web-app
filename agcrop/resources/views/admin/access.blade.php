...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Access List @endslot
    @endcomponent
                        ...
                        <div class="col-sm">
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light"><i
                                        class="bx bx-plus me-1"></i> Add Access</button>
                            </div> -->
                        </div>
                        <div class="col-sm-auto">
                            ...
                            <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light">
                                    <a href="{{ route('access.create') }}" data-key="t-invoice-list">
                                    <i class="bx bx-plus me-1"></i> Add Access</a>
                                </button>
                            </div>
                            </div> 
                        </div>
                        ...
                        <table class="table align-middle datatable dt-responsive table-check nowrap"
                            ...
                            <thead>
                                <tr class="bg-transparent">
                                    ...
                                    <th style="width: 120px;">Access ID</th>
                                    <th>Access Type</th>
                                    <!-- <th>Status</th> -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <form action="{{ route('access.destroy',$access->id) }}" method="POST">
                                                <a class="btn btn-primary" href="{{ route('access.edit',$access->id) }}">Edit</a>
                                                @csrf
                                                @method('DELETE')
