...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Hooter List @endslot
    @endcomponent
                        ...
                        <div class="col-sm">
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light"><i
                                        class="bx bx-plus me-1"></i> Add Hooter</button>
                            </div> -->
                        </div>
                        <div class="col-sm-auto">
                            ...
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light">
                                    <a href="admin.add-Hooter" data-key="t-invoice-list">
                                    <i class="bx bx-plus me-1"></i> Add Hooter</a>
                                </button>
                            </div> -->
                            </div>
                        </div>
                        ...
                        <table class="table align-middle  dt-responsive table-check nowrap"
                            ...
                            <thead>
                                <tr class="bg-transparent">
                                    ...
                                    <th style="width: 120px;">Hooter ID</th>
                                    <th>Hooter Type</th>
                                    <!-- <th>Status</th> -->
