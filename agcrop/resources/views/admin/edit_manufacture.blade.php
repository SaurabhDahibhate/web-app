                ...
                <div class="card-body">
                    ...
                    @method('PATCH')
                      @csrf
                        ...
                        <div class="mb-4">
                            <label class="form-label" for="default-input">manufacture   </label>
                            <input class="form-control" type="text" value="{{ $manufacture->manufacturing }}" name="manufacturing" id="default-input" 
