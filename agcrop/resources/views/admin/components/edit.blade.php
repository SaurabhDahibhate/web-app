...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Edit Component @endslot
    @endcomponent
                    ...
                    <form action="{{ route('components.update', [$component->id]) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" name="name" id="default-input"
                                   placeholder="Enter Component Name" required value="{{ $component->name }}">
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" class="form-control form-select" style="width:250px">
                                        ...
                                        @foreach ($categories as $key => $value)
                                            <option
                                                value="{{ $value->id }}" {{ $component->category_id == $value->id ? 'selected' : '' }} >
                                                {{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <button type="submit" class="btn btn-primary">Edit Component</button>
