...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Regional List @endslot
    @endcomponent
                        ...
                        <div class="col-sm">
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light"><i
                                        class="bx bx-plus me-1"></i> Add Regional</button>
                            </div> -->
                        </div>
                            ...
                            <div class="d-flex align-items-center gap-1 mb-4">
                                <div class="mb-4">
                                    <button type="button" class="btn btn-light waves-effect waves-light">
                                        ...
                                        <i class="bx bx-plus me-1"></i> Add Regional Admin</a>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table align-middle datatable dt-responsive table-check nowrap"
                            ...
                            <thead>
                                <tr class="bg-transparent">
                                    ...
                                    <th style="width: 120px;">Regional ID</th>
                                    <th>Regional Name</th>
                                    <th>Phone No</th>
                                    <th>Username</th>
                                    <th>Password</th>
