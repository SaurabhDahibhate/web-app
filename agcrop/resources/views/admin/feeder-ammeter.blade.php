                        ...
                        <div class="col-sm">
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light"><i
                                        class="bx bx-plus me-1"></i> Add Feeder Ammeter</button>
                            </div> -->
                        </div>
                        <div class="col-sm-auto">
                            ...
                            <!-- <div class="mb-4">
                                <button type="button" class="btn btn-light waves-effect waves-light">
                                    ...
                                    <i class="bx bx-plus me-1"></i> Add Feeder Ammeter</a>
                                </button>
                            </div> -->
                            </div>
                        </div>
                        ...
                        <table class="table align-middle  dt-responsive table-check nowrap"
                            ...
                            <thead>
                                <tr class="bg-transparent">
                                    ...
                                    <th style="width: 120px;">Feeder Ammeter ID</th>
                                    <th>Feeder Ammeter Type</th>
                                    <!-- <th>Status</th> -->
