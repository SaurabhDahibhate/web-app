                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="name" value="{{ $product->name }}" type="text" id="default-input" placeholder="Enter Item Name">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-2">
                                <div class="mb-3">
                                    ...
                                    <select name="unit_id" class="form-control form-select" style="width:250px">
                                        ...
                                        <option value="{{ $value->id}}" {{ ($value->id == $product->unit_id ) ? 'selected' : '' }}>
                                            {{ $value->name }}
                                        </option>
                                            @endforeach
                                    </select>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-2">
                                <div class="mb-3">
                                    ...
                                    <select name="manufacture_id" class="form-control form-select" style="width:250px">
                                        <option value="">Selects Manufacture name</option>
                                        @foreach ($manufacture as $key => $value)

                                        <option value="{{ $value->id}}" {{ ($value->id == $product->manufacture_id) ? 'selected' : '' }}>
                                            {{ $value->name }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-2">
                                <div class="mb-3">
                                    ...
                                    <select name="subcategory_id" class="form-control form-select" style="width:250px">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input class="form-control" name="purchase_rate" value="{{ $product->purchase_rate }}" id="default-input" placeholder="Enter Rate">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <label class="form-label" for="default-input">Purchase Discount </label>
                                <input class="form-control" name="purchase_discount" value="{{ $product->purchase_discount }}" id="default-input" placeholder="Enter Discount in %">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-4">
                                <label class="form-label" for="default-input">Actual Rate </label>
                                <input class="form-control" name="actual_rate" value="{{ $product->actual_rate }}" id="default-input" value="" placeholder=" Actual Rate ">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" name="description" type="text" id="default-input" placeholder="Enter Description"> {{$product->description}} </textarea>
                            </div>
                        </div>
