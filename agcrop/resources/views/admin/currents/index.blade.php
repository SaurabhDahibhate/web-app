...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Currebt Details @endslot
    @endcomponent
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('currents.store') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <button type="submit" class="btn btn-primary">Add Current</button>
                    </form>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <form action="{{ route('currents.destroy',$current->id) }}" method="POST">

                                                <a class="btn btn-warning btn-sm"
                                                   href="{{ route('currents.edit',$current->id) }}"><i class="fas fa-edit"></i></a>
