                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index" class="d-block auth-logo">
                                            ...
                                            <!-- <span class="logo-txt">AG Corporation</span> -->
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0">Welcome Back !</h5>
                                            <p class="text-muted mt-2">Sign in to continue to AG Corporation.</p>
                                        </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Don't have an account ? <a href="user.auth-register"
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        ...
                                        </script> AG Corporation . Crafted with <i
                                                class="mdi mdi-heart text-danger"></i> by Codexxa</p>
                                    </div>
                                </div>
                            </div>
                        </div>
