...
@section('title')
    @lang('translation.Quotation_Detail')
@endsection
@section('content')
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        <th scope="row">HP</th>
                                        <td>
                                            <label>{{ $boqRequest->jockey_hp }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->hydrant_hp }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->stand_by_hp }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->sprinkler_hp }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->engine_hp }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->booster_hp }}</label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>{{ $boqRequest->jockey_no_of_pumps }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->hydrant_no_of_pumps }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->stand_by_no_of_pumps }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->sprinkler_no_of_pumps }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->engine_no_of_pumps }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->booster_no_of_pumps }}</label>
                                        </td>
                                    </tr>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>{{ $boqRequest->volt_meter }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->ammeter }}</label>
                                        </td>
                                        <td>
                                            <label>
                                                @if($boqRequest->is_spp)
                                                    Yes
                                                @else
                                                    No
                                                @endif
                                        ...
                                        <td>
                                            <label>
                                                @if($boqRequest->is_feeder_ammeter)
                                                    Yes
                                                @else
                                                    No
                                                @endif
                                        ...
                                        <td>
                                            <label>{{ $boqRequest->switchMaker->name }}</label>
                                        </td>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>{{ $boqRequest->panel_location }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->panel_color }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->busbar }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->cable_entry }}</label>
                                        </td>
                                        <td>
                                            @if($boqRequest->feeder_ammeter)
                                                Yes
                                            @else
                                                No
                                            @endif
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>{{ $boqRequest->access }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->mounting }}</label>
                                        </td>
                                        <td>
                                            <label>{{ $boqRequest->panelType->name }}</label>
                                        </td>
                                ...
                                <div class="col-sm-4">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-nowrap align-middle mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ₹ {{ json_decode($boqRequest->calculated_data)->total }}</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row" colspan="2" class="border-0 text-end">
                                                        Tax
                                                    </th>
                                                    <td class="border-0 text-end">₹ 00</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row" colspan="2" class="border-0 text-end">Total Panel
                                                        Price
                                                    </th>
                                                    <td class="border-0 text-end">
                                                        <h4 class="m-0">
                                                            ₹ {{ json_decode($boqRequest->calculated_data)->total }}</h4>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="d-print-none mt-3">
                                        <div class="float-end">
                                            ...
                                            @if(!$boqRequest->is_submitted)
                                                <form
                                                    action="{{ route('requisition.quotation.submit', [$boqRequest->id]) }}"
                                                    method="post">

                                                    @csrf

                                                    <button type="submit"
                                                            class="btn btn-primary w-md waves-effect waves-light">Send
                                                    </button>
                                                </form>
                                            @endif
                                        </div>
